#
#  Be sure to run `pod spec lint vincenty.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  see https://github.com/dastrobu/vincenty.
                   DESC

  s.homepage     = "https://github.com/dastrobu/vincenty"
  ...
  s.source       = { :git => "https://github.com/dastrobu/vincenty.git", :tag => "#{s.version}" }
